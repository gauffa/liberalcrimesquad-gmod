...
void makecharacter(void)
{
   ...
   newcr->set_attribute(ATTRIBUTE_HEART,99);
   newcr->set_attribute(ATTRIBUTE_WISDOM,1);
   newcr->set_attribute(ATTRIBUTE_INTELLIGENCE,99);
   newcr->set_attribute(ATTRIBUTE_AGILITY,99);
   newcr->set_attribute(ATTRIBUTE_STRENGTH,99);
   newcr->set_attribute(ATTRIBUTE_HEALTH,99);
   newcr->set_attribute(ATTRIBUTE_CHARISMA,99);
   for(int sk=0;sk<SKILLNUM;sk++)newcr->set_skill(sk,99);
